...
onScrollBottom转译成scrollbottom, onScrollToLower转译成scrollend。

在其他小程序下， list-item标签变div，scroll-view标签不变，onScrollBottom转译成bindscrollbottom, 
onScrollToLower转译成bindscrolltolower。
